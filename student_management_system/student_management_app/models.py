...
def create_user_profile(sender, instance, created, **kwargs):
    if created:
        ...
        if instance.user_type == 3:
            Students.objects.create(admin=instance, course_id=Courses.objects.get(id=1), parent_roll_number="",
        ...
        if instance.user_type == 4:
            Parents.objects.create(admin=instance, parent_address="", parent_ph_no="", father_occupation="",
                                   mother_occupation="", parent_roll_number="")
        '''
        if instance.user_type == 3:
