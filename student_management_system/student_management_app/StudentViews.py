...
from student_management_app.models import Students, Courses, Subjects, CustomUser, Attendance, AttendanceReport, \
    FeedBackStudent, LeaveReportStudent, NotificationStudent, StudentResult, SessionYearModel, Parents
...
def student_profile(request):
    ...
    parent = Parents.objects.get(admin=user2)
    print(user,user1)
    return render(request, "student_template/student_profile.html", {"user": user, "user2": user2, "student": student, "parent": parent})
