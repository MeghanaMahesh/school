...
from student_management_app import views, HodViews, StaffViews, StudentViews, ParentViews
...
urlpatterns = [
    ...
    path('select_student_class', HodViews.select_student_class, name="select_student_class"),
    path('select_subject', HodViews.select_subject, name="select_subject"),
    ...
    path('check_parent_email_exist', HodViews.check_parent_email_exist, name="check_parent_email_exist"),
    path('check_roll_number_exist', HodViews.check_roll_number_exist, name="check_roll_number_exist"),
    #path('check_parent_roll_number_exist', HodViews.check_parent_roll_number_exist, name="check_parent_roll_number_exist"),
    path('check_teacher_roll_number_exist', HodViews.check_teacher_roll_number_exist, name="check_teacher_roll_number_exist"),
    path('check_username_exist', HodViews.check_username_exist, name="check_username_exist"),
    path('check_parent_username_exist', HodViews.check_parent_username_exist, name="check_parent_username_exist"),
    ...
    path('select_attendance_class', HodViews.select_attendance_class, name="select_attendance_class"),
    ...
    path('select_class', StaffViews.select_class, name="select_class"),
    path('edit_select_class', StaffViews.edit_select_class, name="edit_select_class"),
    path('edit_result_select_class_session', StaffViews.edit_result_select_class_session, name="edit_result_select_class_session"),
    path('manage_student_result_list_display', StaffViews.manage_student_result_list_display, name="manage_student_result_list_display"),
    path('edit_student_result/<str:student_id>', StaffViews.edit_student_result, name="edit_student_result"),
    path('edit_student_result_save', StaffViews.edit_student_result_save, name="edit_student_result_save"),
